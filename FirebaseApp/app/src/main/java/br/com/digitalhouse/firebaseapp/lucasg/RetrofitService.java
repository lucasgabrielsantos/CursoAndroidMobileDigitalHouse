package br.com.digitalhouse.firebaseapp.lucasg.network;
...
public class RetrofitService {
    ...
    public static br.com.digitalhouse.firebaseapp.lucasg.network.API getApiService() {
        return getRetrofit().create(br.com.digitalhouse.firebaseapp.lucasg.network.API.class);
    }
}
